...
export class AuditoriumInstance extends Scene {
    ...
    constructor() {
        ...
        this.currentvid
        //this.screen1.myVideoTexture1.play()
    ...
    goLobby(position: Vector3, direction: Vector3) {
        ...
        this.screen1.myVideoTexture1.pause()
        
        this.screen1.myVideoTexture2.pause()
        
        this.screen1.myVideoTexture3.pause()
    ...
    createMovieScreen() {
        ...
        log("this is location",)
        this.screen1.setParent(this)
        this.screen1.addComponentOrReplace(new PlaneShape())
        this.screen1.addComponentOrReplace(new Transform({
    ...
    createConsoleButtons() {
        ...
        this.consolebuttonprev.addComponentOrReplace(new OnPointerDown(() => {
            if (this.currentvid == 1) {
                this.screen1.myVideoTexture1.pause()
                this.screen1.myVideoTexture1.reset()
                // engine.removeEntity(this.screen1)
                // engine.addEntity(this.screen3)
                this.screen1.myMaterial.albedoTexture = this.screen1.myVideoTexture3
                this.screen1.myVideoTexture3.play()
                this.currentvid = 3
                return
            ...
            if (this.currentvid == 2) {
                this.screen1.myVideoTexture2.pause()
                this.screen1.myVideoTexture2.reset()
                // engine.removeEntity(this.screen2)
                // engine.addEntity(this.screen1)
                this.screen1.myMaterial.albedoTexture = this.screen1.myVideoTexture1
                this.screen1.myVideoTexture1.play()
                this.currentvid = 1
                return
            }
            if (this.currentvid == 3) {
                this.screen1.myVideoTexture3.pause()
                this.screen1.myVideoTexture3.reset()
                // engine.removeEntity(this.screen3)
                // engine.addEntity(this.screen2)
                this.screen1.myMaterial.albedoTexture = this.screen1.myVideoTexture2
                this.screen1.myVideoTexture2.play()
                this.currentvid = 2
                return
            }
