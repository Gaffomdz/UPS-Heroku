...
import { Article4page1, Article4page10, Article4page2, Article4page3, Article4page4, Article4page5, Article4page6, Article4page7, Article4page8, Article4page9 } from "../articleResources/article4"

export class dynamicArticle4 extends Entity{
    ...
    loadPages(){
        ...
        this.page1.addComponentOrReplace(Article4page1)
        this.page2.addComponentOrReplace(Article4page2)
        this.page3.addComponentOrReplace(Article4page3)
        this.page4.addComponentOrReplace(Article4page4)
        this.page5.addComponentOrReplace(Article4page5)
        this.page6.addComponentOrReplace(Article4page6)
        this.page7.addComponentOrReplace(Article4page7)
        this.page8.addComponentOrReplace(Article4page8)
        this.page9.addComponentOrReplace(Article4page9)
        this.page10.addComponentOrReplace(Article4page10)
    }
    ...
    nextPage(){
        ...
        if(this.pagenum ==9){
            this.pageSpawn(this.page9, this.page10)
            this.pagenum = 10
        }else

        if(this.pagenum == 10){
            this.pageSpawn(this.page10, this.page1)
            this.pagenum = 1
        }
    }
    }
    prevPage(){
        ...
        if(this.cooldown==0){
            this.cooldown=1
        if(this.pagenum ==1){
            this.pageSpawn(this.page1, this.page10)
            this.pagenum = 10
            log('pagenum: '+ this.pagenum)
        }else

        if(this.pagenum == 10){
            this.pageSpawn(this.page10, this.page9)
            this.pagenum = 9
        }else
